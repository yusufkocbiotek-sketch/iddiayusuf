...
artifact_path = os.path.join(artifact_dir, "Analiz_Blok_274_293.md")

with open(r'C:\Users\YUSUF\Desktop\iddiayusuf-main\public\data\gecmis_maclar.json', 'r', encoding='utf-8') as f:
    data = json.load(f)

output_text = "# KAPSAMLI 20 MAÇLIK ANALİZ RAPORU (İndex: -274 / -293)\n\n"
output_text += "Bu rapor makine tarafından oluşturulmuş tam teşekküllü şablonları içerir.\n\n"
