...
old_1467 = """        if 2.20 <= ms1 <= 2.65 and 2.20 <= ms2 <= 2.65 and ms0 <= 3.20 and ust25 != 99.0 and ust25 >= 1.60:
...
new_1467 = """        if 2.20 <= ms1 <= 2.65 and 2.20 <= ms2 <= 2.65 and ms0 <= 3.20 and ust25 != 99.0 and ust25 >= 1.60:
            kg_yok = get_odd(odds, ["Karşılıklı Gol_Yok"])
