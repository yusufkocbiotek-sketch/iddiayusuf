...
def main():
    ...
    out_file = r'C:\Users\YUSUF\.gemini\antigravity\brain\d6708fe4-425a-4c22-8337-22d967dd2651\Analiz_Blok_491_495.md'
    
    indices = [-491, -492, -493, -494, -495]
    
    with codecs.open(out_file, 'w', 'utf8') as out:
        out.write("# Kör Test Sonuçları (İndex -491 ile -495 Arası)\n\n")
    ...
    print("Test tamamlandı, dosya oluşturuldu.")
