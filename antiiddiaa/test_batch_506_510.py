...
def main():
    ...
    out_file = r'C:\Users\YUSUF\.gemini\antigravity\brain\d6708fe4-425a-4c22-8337-22d967dd2651\Analiz_Blok_506_510.md'
    
    indices = [-506, -507, -508, -509, -510]
    
    with codecs.open(out_file, 'w', 'utf8') as out:
        out.write("# Kör Test Sonuçları (İndex -506 ile -510 Arası)\n\n")
