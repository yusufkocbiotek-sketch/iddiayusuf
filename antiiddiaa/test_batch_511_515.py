...
def main():
    ...
    out_file = r'C:\Users\YUSUF\.gemini\antigravity\brain\d6708fe4-425a-4c22-8337-22d967dd2651\Analiz_Blok_511_515.md'
    
    indices = [-511, -512, -513, -514, -515]
    
    with codecs.open(out_file, 'w', 'utf8') as out:
        out.write("# Kör Test Sonuçları (İndex -511 ile -515 Arası)\n\n")
