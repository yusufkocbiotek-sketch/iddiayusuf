...
def main():
    ...
    out_file = r'C:\Users\YUSUF\.gemini\antigravity\brain\d6708fe4-425a-4c22-8337-22d967dd2651\Analiz_Blok_516_520.md'
    
    indices = [-516, -517, -518, -519, -520]
    
    with codecs.open(out_file, 'w', 'utf8') as out:
        out.write("# Kör Test Sonuçları (İndex -516 ile -520 Arası)\n\n")
