...
def main():
    ...
    out_file = r'C:\Users\YUSUF\.gemini\antigravity\brain\d6708fe4-425a-4c22-8337-22d967dd2651\Analiz_Blok_496_500.md'
    
    indices = [-496, -497, -498, -499, -500]
    
    with codecs.open(out_file, 'w', 'utf8') as out:
        out.write("# Kör Test Sonuçları (İndex -496 ile -500 Arası)\n\n")
