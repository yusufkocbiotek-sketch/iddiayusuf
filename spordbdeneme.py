...
# ⚙️ AYARLAR
# =========================
BASLANGIC_TARIHI = "07.06.2026"
BITIS_TARIHI = "07.06.2026"
...
def fetch_day(driver, gun):
    ...
    try:
        ...
        # Bu sayede sayfa yenilense bile elimizde link listesi olacak, hata olmayacak.
...
def merge_data(mevcut, yeni):
    ...
    for sp in yeni:
        ...
        for idx, mevcut_mac in enumerate(mac_listesi):
            tar1 = mevcut_mac.get("tarih", "").replace("-", "").replace(".", "")
            tar2 = sp.get("tarih", "").replace("-", "").replace(".", "")
...
if __name__ == "__main__":
    print("="*60)
    print("🚀 SPORDB | STALE HATASI ÇÖZÜLDÜ | TÜM MAÇLAR GELECEK ✅")
    print("="*60)
